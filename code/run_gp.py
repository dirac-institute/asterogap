...
if __name__ == "__main__":
    ...
    #                     help="The period of an asteroid in hour (if known).")
    ...
    parser.add_argument('-k', '--kernel', action="store_false", dest="kernel", required=False, default=True,
                        help="Include a long-term lightcurve profile adjustment kernel.")
    parser.add_argument('-c', '--columns', action="store", dest="columns", required=False, default=(0,1,2),
